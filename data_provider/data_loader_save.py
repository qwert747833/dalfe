...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path="iTransformer_datasets/ETT-small", flag='train', size=None, 
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path="iTransformer_datasets/weather", flag='train', size=None,
